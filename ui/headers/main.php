...
<body>
    ...
    <header id="header">
        ...
        <section id="main_header">
            ...
            <div id="logo">
                <a href="index" name="Homepage" title="Click to go back to homepage"> <img src="_assets/logo/blue-diamond-warri-logo.png" width="auto" height="65" alt="blue diamond school logo"> </a>
            </div>

            
        <div id="main_links">

            <a  href="tel: 07085898670" class="dd_shortline"> <i class="pe-7s-call"></i> Call 0708 589 8670 </a>
